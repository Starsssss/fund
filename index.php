...
function jj($code,$name)
{
    ...
    if ($response) {
        ...
        if ($data) {
            ...
            // var_dump($today_percentage,empty($today_percentage)?NULL:$today_percentage);die;
            $data = array(
                'code' => $code,
                ...
                'today_percentage' => empty($today_percentage)?NULL:$today_percentage,
                'max_draw_down_1y' => $fundRateDetail['data']['index_data_list'][0]['average_index']['max_draw_down'] ?:NULL,
                'max_draw_down_3y' => $fundRateDetail['data']['index_data_list'][1]['average_index']['max_draw_down'] ?:NULL,
                'max_draw_down_5y' => $fundRateDetail['data']['index_data_list'][2]['average_index']['max_draw_down']?:NULL,
                'sharpe_rank_1y' => $fundRateDetail['data']['index_data_list'][0]['average_index']['sharpe_rank']?:NULL,
                'sharpe_rank_3y' => $fundRateDetail['data']['index_data_list'][1]['average_index']['sharpe_rank']?:NULL,
                'sharpe_rank_5y' => $fundRateDetail['data']['index_data_list'][2]['average_index']['sharpe_rank']?:NULL,
                'volatility_rank_1y' => $fundRateDetail['data']['index_data_list'][0]['average_index']['volatility_rank']?:NULL,
                'volatility_rank_3y' => $fundRateDetail['data']['index_data_list'][1]['average_index']['volatility_rank']?:NULL,
                'volatility_rank_5y' => $fundRateDetail['data']['index_data_list'][2]['average_index']['volatility_rank']?:NULL,
...
$rowArr = [];
/* $data=array_filter($data1, function ($item) {
    return intval($item[0]) >970170 ;
}); */
$count=count($data);
